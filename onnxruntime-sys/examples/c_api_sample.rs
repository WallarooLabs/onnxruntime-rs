...
fn main() {
    ...
    let input_node_names_ptr: Vec<*const std::os::raw::c_char> = input_node_names_cstring
        ...
        .collect();
    let input_node_names_ptr_ptr: *const *const std::os::raw::c_char =
        input_node_names_ptr.as_ptr();
    ...
    let output_node_names_ptr: Vec<*const std::os::raw::c_char> = output_node_names_cstring
        ...
        .collect();
    let output_node_names_ptr_ptr: *const *const std::os::raw::c_char =
        output_node_names_ptr.as_ptr();

    let _input_node_names_cstring = unsafe {
        std::ffi::CString::from_raw(input_node_names_ptr[0] as *mut std::os::raw::c_char)
    };
